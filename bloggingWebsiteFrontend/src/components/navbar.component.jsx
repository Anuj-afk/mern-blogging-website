    ...
    return(
        <>
            <nav className="navbar">
                ...
                <div className="flex items-center gap-3 mad:gap-6 ml-auto">
                    ...
                    <>
                        ...
                        <div className = "relative" onClick={handleUserNavPanel} onBlur={handleBlur}>
                            <button className="w-12 h-12 mt-1">
                                <img src={profile_img} referrerPolicy="no-referrer" className="w-full h-full rounded-full object-cover"></img>
                            </button>
