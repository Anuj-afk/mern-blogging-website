...
const PublishForm = () => {
    ...
    const publishBlog = (e) => {
        ...
        if(!des.length || des.length > characterLimit){
            return toast.error(`Add a description to publish it, within ${characterLimit} characters`)
        }
        if(!tags.length || tags.length > tagLimit){
            return toast.error(`Add at least one tag to publish it, Maximum ${tagLimit} tags`)
        }
        ...
        <AnimationWrapper>
            <section className="w-screen min-h-screen grid items-center lg:grid-cols-2 py-16 lg:gap-16">
                ...
                <div className="border-grey lg:border-1 lg:pl-8">
                    ...
                    <input className="input-box pl-4" type="text" placeholder="Blog Tilte" defaultValue={title} onChange={handleBlogTitleChange}/>

                    <p className="text-dark-grey mb-2 mt-9">Short Description about your blog</p>
                    <textarea name="" id="" maxLength={characterLimit} defaultValue={des} className="h-40 resize-none leading-7 input-box pl-4" onChange={handleBlogDesChange} onKeyDown={handleTitleKeyDown}></textarea>
                    ...
                    <div className="relative input-box pl-2 py-2 pb-4">
                        ...
                        {
                            tags.map((tag, index) => <Tag key={index} tagIndex = {index} tag={tag}></Tag>)
                        }
